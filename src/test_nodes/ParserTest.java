...
public class ParserTest {
        ...
        public AbstractNode parseAndCreateTree(String string, Turtle turtle)
                ...
                for (Function function : myParser.getFunctions()) {
                        System.out
                                        .println("ParserTest parseAndCreateTree: myFunctions are "
                                                        + function);
        ...
        public void traverseTree(Turtle turtle, AbstractNode node) throws ClassNotFoundException, NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchFieldException, IOException {
